...
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <asp:GridView ID="FormView1" runat="server" AutoGenerateColumns="False" DataKeyNames="maSach" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
        <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QLTV_ThucTapConnectionString %>" SelectCommand="SELECT * FROM [SACH]" DeleteCommand="DELETE FROM [SACH] WHERE [maSach] = @maSach" InsertCommand="INSERT INTO [SACH] ([maSach], [maTL], [maTG], [maNXB], [tenSach], [gia], [soLuong], [soLuongTon]) VALUES (@maSach, @maTL, @maTG, @maNXB, @tenSach, @gia, @soLuong, @soLuongTon)" UpdateCommand="UPDATE [SACH] SET [maTL] = @maTL, [maTG] = @maTG, [maNXB] = @maNXB, [tenSach] = @tenSach, [gia] = @gia, [soLuong] = @soLuong, [soLuongTon] = @soLuongTon WHERE [maSach] = @maSach">
            <DeleteParameters>
